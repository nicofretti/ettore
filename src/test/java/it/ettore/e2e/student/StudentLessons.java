...
public class StudentLessons extends E2EBaseTest {
    ...
    Lesson lessonOne;
    Lesson lessonTwo;
    StudentCoursesPage  coursesPage;
    ...
    public void prepareLessonsTests() {
        ...
        coursesPage = loginPage.loginAsStudent();
    }
    ...
    public void breadcrumbs() {
        ...
        //click on course
        StudentCoursePage courseDetails = coursesPage.getCourses().get(0).goTo();
        ...
        StudentLessonsPage lessonsPage = courseDetails.goToLessons();
        assertEquals(List.of(
                new Breadcrumb("COURSES", "/student/courses"),
                new Breadcrumb("COURSE NAME", String.format("/student/courses/%d", course.getId())),
...
//        StudentCoursePage courseDetails = courses.get(0).goTo();
//
//        // Should be in the details page for the course
//        assertEquals(String.format("/student/courses/%d", course.getId()), currentPath());
//
...
//        assertEquals(String.format("/student/courses/%d/lessons/%d", course.getId(), lessonOne.getId()), currentPath());
